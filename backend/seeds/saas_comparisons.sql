...
(
    ...
    $json$[
      ...
      {"type":"paragraph","text":"Against that, Zoho Invoice has time tracking built in, which matters if you bill by the hour, and it sits inside a suite. When invoicing alone stops being enough, Zoho Books picks up where it leaves off at 20 USD a month with your data already in place. Wave's own step up is 190 USD a year for receipt capture and automation."},
