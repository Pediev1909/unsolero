...
### Формат B — Анимирани карти

На екрана се местят 2–4 карти, например:
...
**Подготовка:** направете пет title cards в Kdenlive. Ако показвате vendor
страници, отворете официалните pricing pages предварително и не показвайте
цена, която не е проверена същия ден.
...
| 4–7 сек. | Card 1 влиза отдолу или просто се появява. | `Which workflow is broken?` |
| 7–10 сек. | Card 2 заменя card 1. | `Who will maintain it?` |
| 10–13 сек. | Card 3 заменя card 2. | `What must it connect to?` |
| 13–16 сек. | Трите cards се подреждат вертикално. | `CONSTRAINTS FIRST.` |
...
**Формат:** анимирани карти + voiceover
...
**Формат:** screenshot на коментар + карти
**Продължителност:** 30–35 секунди
...
Картите се появяват последователно:
